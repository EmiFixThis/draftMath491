...
\todo[inline]{Introduce the "Attack Models" section before jumping
right in to models.}
...
\todo[inline]{What are these? Are these the assumptions? Maybe put them in a table or something, or at least label them as assumptions.}
