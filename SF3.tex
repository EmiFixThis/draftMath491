...
In addition to their seeming quantum-safe features \todo[inline]{What???!? You haven't really talked about how or why lattice crypto is supposedly quantum safe. You def need a section on that.}lattice-based schemes have the potential of providing Fully Homomorphic Encryption (FHE) to a given cryptosystem. 
...
\todo[inline]{It's not clear to me why there is a discussion of boolean circuits/logic here? I think you can safely remove this; I'm just confused by it.}
